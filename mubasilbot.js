...
var rules = {
  ...
  "~*x computer ~*y": [
    "Computers are cool, right?",
    "Do you even know how to use a computer? *rolls eyes* ",
    "Don't you think computers can help people",
    "IF YOU CAN'T TALK ABOUT COMPUTERS NICELY PLEASE DON'T TALK TO ME!",
  ...
  "~*x I remember ~*y": [
    "I'm not interested in listening about ~y?",
    "Stop talking about the past, dude. Look at the future.",
    "AGAIN?",
    "OK. F**K it. It clearly looks like you won't listen so why are you remembering ~y this right now? And why should I care about it?? ",
   
  ],

  "~*x I want ~*y": [
    "And I want a Porsche. Do you see that happening?",
    "I honestly don't care. Why are you talking to me again?",
    "Stop acting like an entitled brat! If you want ~y go get it.",
  ],
    "~*x I need ~*y": [
    "LOL. you need ~y so why don't you do something about it?",
    "OK. Do you think I have powers or something? ",
    "I honestly don't care. Why are you talking to me again?",
  ],
  "~*x if ~*y": [
...
var default_responses = [
  "I'm an introvert, and I don't like talking to people. so, yeah, stop typing.",
  "you should really improve your grammar.",
  "*Rolls eyes*",
  "*Sigh*",
  "Blah blah blah. ",
  "same.",
...
function interact() {
  ...
  r.innerHTML = " Mubasil [" + t2 + "]: <code>" + response + "</code><br>" + r.innerHTML ;
  q.value = "";
}
